    ...
    <el-container class="login">
        ...
        <el-main style="padding: 0px">
            <el-row>
                <el-col :span="24">
                    <div>
                        <div id="form-title">自动化平台《xuxc》</div>
                        <form id="submit-form">
                            <div id="form-content">
                                ...
                                <div id="form-inputs">
                                    <div class="form-input-div">
                                        <i class="iconfont"
                                           style="position: absolute; bottom: 438px; padding-left: 10px">&#xe61c;</i>
                                    ...
                                    <div class="form-input-div">
                                        ...
                                        <div class="err_msg" id="user_name" v-html="nameInvalid"
                                             @mouseover="nameInvalid=''"></div>
                                ...
                                <div class="form-foot">
                                    <span>已有账户，<router-link to="/testrunner/login">立即登陆</router-link></span>
                                </div>
...
<script>
import {register} from "../../restful/userinfo";
    export default {
        name: "Register",
        data() {
            return {
        ...
        rules: {
                    name: [
                        ...
                        {min: 1, max: 20, message: '最多不超过20个字符', trigger: 'blur'}
                    ],
                    },
        methods: {
            validateUser() {
