        ...
        <el-header style="background: #fff; padding: 0; height: 50px">
            <div class="nav-api-header">
                <div style="padding-top: 10px; margin-left: 20px">
                    <el-button
                        v-show="reportData.count !== 0 && permissions.includes('delete')"
...
<script>
    ...
    import {downloadTestdata} from '../../restful/filepage'
    ...
    export default {
        ...
        methods: {
            ...
            handleWatchReports(index) {
                ...
                reportapi.watchSingleReports(index, {params:{project:this.$route.params.id}}).then(resp => {
                    ...
                    if (resp.status == 200){
                        ...
                        this.$notify.error("查看报告失败，报告不存在或已被删除")
                        this.currentPage=1;
                        this.getReportList();
                        return false
                    }
            ...
            handleCurrentChange(val) {
                reportapi.getReportsPaginationBypage({
                    params: {
            ...
            handleDelReports(index) {
                this.$confirm('此操作将永久删除该测试报告，是否继续?', '提示', {
                    ...
                    reportapi.deleteReports(index,{params:{project:this.$route.params.id}}).then(resp => {
            ...
            getpermissions() {
                getpermissions({app_label:"test_runner",model:"report"}).then(resp => {
            ...
            delSelectionReports() {
                if (this.selectReports.length !== 0) {
                    this.$confirm('此操作将永久删除勾选的测试报告，是否继续?', '提示', {
                        ...
                        reportapi.delAllReports(this.selectReports,{project:this.$route.params.id}).then(resp => {
