                ...
                >
                    <template slot-scope="props">
                        <el-tabs >
                            ...
                            <el-tab-pane label="内容" v-if="props.row.meta_data.response.content !== null">
                            ...
                            <el-tab-pane label="断言信息" v-if="props.row.meta_data.validators.length !== 0">
                                <pre class="code-block" v-html="props.row.meta_data.validators"></pre>
                            </el-tab-pane>
                            <el-tab-pane label="异常信息" v-if="props.row.attachment !== ''">
