    ...
    <div>
        ...
        <div class="request">
            ...
            >
                ...
                <el-tab-pane label="提取器" name="third">
                    <extract
                        :save="save"
                ...
                <el-tab-pane label="变量设置" name="five">
                    <variables
                        :save="save"
                ...
                <el-tab-pane label="前后置方法设置" name="six">
                    <hooks
                        :save="save"
                ...
                <el-tab-pane label="数据库操作" name="seven">
                    <sqlVariables
                        :save="save"
                        v-on:sqlVariables="handlesqlVariables"
                        :sqlVariables="response ? response.body.sqlVariables: []"
                    >
                    </sqlVariables>
                </el-tab-pane>
            </el-tabs>
...
<script>
    ...
    import sqlVariables from '../../../httprunner/components/sqlVariables'
    ...
    export default {
        ...
        methods: {
            ...
            handlesqlVariables(sqlVariables){
            ...
            updateAPI() {
                if (this.validateData()) {
                    api.updateAPI(this.id, {
                        header: this.header,
                        request: this.request,
                        extract: this.extract,
                        validate: this.validate,
                        variables: this.variables,
                        sqlVariables:this.sqlVariables,
                        hooks: this.hooks,
                        url: this.url,
                        method: this.method,
                        name: this.name,
        ...
        watch: {
            response: function () {
                ...
                this.sqlVariables=this.response.sqlVariables;
            }
        },
        data() {
            return {
