                        ...
                        >
                            ...
                            <div class="block block_post" v-if="item.method.toUpperCase() === 'POST' ">
                                ...
                                <el-tooltip :content="item.url" placement="top">
                                    <span class="block-method block_url test_demo_ellipsis">{{item.url}}</span>
                                </el-tooltip>
                                <el-tooltip :content="item.name" placement="top">
                                    <span class="block-summary-description test_demo_ellipsis">{{item.name}}</span>
                                </el-tooltip>
                            </div>
                            ...
                            <div class='test-list'>
                                ...
                                >                    
                                    ...
                                    >                                      
                                        ...
                                        <span class="test_demo_ellipsis">{{test.name}}</span>
                                        <el-button
...
<script>
    ...
    import {getPaginationBypage,apiList}  from '../../../../restful/apipage'
    ...
    export default {
        ...
        methods: {
            ...
            updateTestSuite() {
                ...
                apicase.updateTestCase(this.testId, {
                    length: length,
                    name: this.testName,
                    tag: this.testTag,
                    body: this.testData,
