...
new Vue({
    ...
    created() {
        ...
        if (this.getLocalValue("useractualname") === null) {
            this.setLocalValue("useractualname", "");
        }
        if (this.getLocalValue("email") === null) {
            this.setLocalValue("email", "");
        }
        if (this.getLocalValue("Is_superuser") === null) {
            this.setLocalValue("Is_superuser", "");
        }
        ...
        this.$store.commit("setUseractualname", this.getLocalValue("useractualname"));
        this.$store.commit("setUseEmail", this.getLocalValue("email"))
        this.$store.commit("setIs_superuser", this.getLocalValue("Is_superuser"))
